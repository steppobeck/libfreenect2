...
device_dtrack::readLoop()
{
  ...
  while (_running) {
    ...
    //std::cout << "ART_framenr_after_recv: " << framenr << std::endl;
	  ...
	  */
	  ...
	  m_data[0] = b.rot[0]; m_data[4] = b.rot[3]; m_data[8]  = b.rot[6];  m_data[12] = b.loc[0] / 1000.0;
		...
		timeoffset = tick - timestamp;
	      ...
	      //std::cerr << "------------------------------------------" << std::endl;
	      //std::cout << "system_clock: " << std::setprecision(20) << tick << std::endl;
	      //std::cout << "ART_clock: " << std::setprecision(20) << timestamp << std::endl;
	      //std::cout << "ART_system_clock: " << std::setprecision(20) << art_tick << std::endl;
	      //std::cout << "ART_framenr: " << framenr << std::endl;
	      //std::cout << framenr << " " << std::setprecision(20) << art_tick << std::endl;
